                                ...
                                <div className="heading">
                                    ...
                                    <div name="signin" className="form">
                                        <div className="input-control">
                                            <label htmlFor="email" className="input-label" hidden>Tài khoản</label>
                                        ...
                                        <div className="input-control">
                                            <label htmlFor="password" className="input-label" hidden>Mật khẩu</label>
                                        ...
                                        <div className="input-control">
                                            <a href onClick={() => setOpen(() => true)} className="text text-links">Quên mật khẩu</a>
                                            <input onClick={async (e) => {
                                                e.preventDefault()
                                                const result = await login(email, password)
                                                if (result?.login === false) {
                                                    return swal("Thông báo", "Đăng nhập thất bại, Email hoặc mật khẩu không chính xác", "error")
                                                }
                                                else if (result?.login === true && result?.isAdmin=== true) {
                                                    return swal("Thông báo", "Đăng nhập thành công", "success").then(() => Cookies.set("uid", result.id_user)).then(() => navigate("/admin")).then(() => window.location.reload())

                                                }
                                                else if(result?.isAdmin !== true) {
                                                    return swal("Thông báo", "Đăng nhập thất bại, bạn không có quyền vào trang này", "error")
                                                }
                                                else {
                        ...
                        parseInt(roleLogin)=== 2 && <>
                                {
                                    ...
                                    <div className="container">
                                        <section className="wrapper">
                                            ...
                                            <div name="signin" className="form">
                                                <div className="input-control">
                                                    <label htmlFor="email" className="input-label" hidden>Địa chỉ email</label>
                                                    <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" name="email" id="email" className="input-field" placeholder="Email Address" />
                                                </div>
                                                <div className="input-control">
                                                    <label htmlFor="password" className="input-label" hidden>Mật khẩu</label>
                                                ...
                                                <div className="input-control">
                                                    ...
                                                    <input onClick={async (e) => {
                                                        ...
                                                        else if (result?.login === true && result?.isEmployee=== true) {
                                                            swal("Thông báo", "Đăng nhập thành công", "success").then(() => Cookies.set("uid", result.id_user)).then(() => navigate("/staff")).then(() => window.location.reload())
                                    ...
                                    <div className="container">
                                        <section className="wrapper">
                                            <div className="heading">
                                                ...
                                                <p className="text text-normal">Bạn là người mới? <span><Link to={"/signup"} className="text text-links">Tạo tài khoản</Link></span>
                                                </p>
                                            </div>
                                            <div name="signin" className="form">
                                                <div className="input-control">
