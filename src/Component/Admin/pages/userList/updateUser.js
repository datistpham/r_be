      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
            <TextField style={{width: 350}} value={firstName} onChange={(e)=> setFirstName(e.target.value)} placeholder={"User name"} />
            <div></div>
            <br />
            <div></div>
            <TextField style={{width: 350}} value={lastName} onChange={(e)=> setLastName(e.target.value)} placeholder={"Phone"} />
            <div></div>
            <br />
            <div></div>
